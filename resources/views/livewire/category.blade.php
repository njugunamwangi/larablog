<div class="container mx-auto py-6 flex flex-wrap">
                        ...
                        <div class="bg-white flex flex-col justify-start p-6">
                            ...
                            <div>
                                @foreach($article->locations as $location)
                                    <a href="{{ route('by-location', $location) }}" class="bg-blue-500 mb-5 inline-block rounded-full py-1 px-4 text-center text-xs font-semibold leading-loose text-white">
                                        {{$location->location}}
                                    </a>
                                @endforeach
                            </div>
    ...
    <livewire:sidebar :category='$category' />
</div>
